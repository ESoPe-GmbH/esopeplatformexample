...
#define MODULE_ENABLE_RESOURCE_FILE						0
...
#define MODULE_ENABLE_SWUPDATE							1

/// Enables the swupdate Module
/// When enabled, the sw_update_routine can be automatically enabled during start-up. See defines in @see sw_update_mmc.h
#define MODULE_ENABLE_SWUPDATE_ESO                      1
...
#define MODULE_ENABLE_FLASH_ESP							1
...
#define MODULE_ENABLE_NETWORK_ESP_INTERNAL				1
...
#define MODULE_ENABLE_SERIALIZATION_BINARY_BUFFER       0
...
#define MODULE_ENABLE_UTIL_MEM_POOL                     0
...
#define MODULE_ENABLE_WEBSERVER							1

/// Enables the websocket module.
#define MODULE_ENABLE_WEBSOCKET                         1
