...
#define MCU_PERIPHERY_ENABLE_ETHERNET 				false
/// Enable/disable wifi of mcu.
#define MCU_PERIPHERY_ENABLE_WIFI 					false
/// Number of allocated IO Interrupt instances.
#define MCU_PERIPHERY_DEVICE_COUNT_IO_INTERRUPT		2
/// Number of allocated Timer instances.
#define MCU_PERIPHERY_DEVICE_COUNT_TIMER			1
/// Number of allocated UART instances.
#define MCU_PERIPHERY_DEVICE_COUNT_UART				3
/// Number of allocated SPI instances.
#define MCU_PERIPHERY_DEVICE_COUNT_SPI				1
/// Number of allocated I2C instances.
#define MCU_PERIPHERY_DEVICE_COUNT_I2C				1					
/// Number of allocated CAN instances.
#define MCU_PERIPHERY_DEVICE_COUNT_CAN				1
...
#define MCU_ENABLE_FREERTOS							true
...
#include "mcu/espressif/esp32/mcu_controller.h"	// Includes the controller specific definitions and enumerations
